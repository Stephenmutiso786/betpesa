...
$form_action = basename($_SERVER['SCRIPT_NAME'] ?: 'open.php');
?>
<h1><?php echo __('Open a New Ticket');?></h1>
<p><?php echo __('Please fill in the form below to open a new ticket.');?></p>
<form id="ticketForm" method="post" action="<?php echo Format::htmlchars($form_action); ?>" enctype="multipart/form-data">
  <?php csrf_token(); ?>
